...
/**
 * Change Request - A class to represent a change request for a Interpolated Value.
...
/**
 * Interpolated Value - A class for creating values that will *LERP* to the new value they are set to.
...
class InterpolatedValue {
    ...
    /**
     * Set - Makes a new request to pass into our stack runner.
